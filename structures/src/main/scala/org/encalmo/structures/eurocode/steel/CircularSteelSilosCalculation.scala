...
class CircularSteelSilosCalculation extends CalculationDocument {
    ...
    val silos = new ThinWalledCircularSlenderSilosWithSteepHopper(
            ...
            thicknessOfHopperWall = 10 unit SI.mm,
    ...
    override val doc = Document("",
        ...
        Chapter("",
            ...
            NumSection("Wykaz materiałów źródłowych",
                NumSection(styleComment," [1991-1-3] Norma PN-EN 1991-1-3 \"Eurokod 1. Oddziaływania na konstrukcje. Część 1-3: Oddziaływania ogólne. Obciążenia śniegiem.\""),
                NumSection(styleComment," [1991-1-4] Norma PN-EN 1991-1-4 \"Eurokod 1. Oddziaływania na konstrukcje. Część 1-4: Oddziaływania ogólne. Oddziaływania wiatru.\""),
            	NumSection(styleComment," [1991-4] Norma PN-EN 1991-4 \"Eurokod 1. Oddziaływania na konstrukcje. Część 4: Silosy i zbiorniki.\""),
            	NumSection(styleComment," [1993-1-1] Norma PN-EN 1993-1-1 \"Eurokod 3. Projektowanie konstrukcji stalowych. Część 1-1: Reguły ogólne dla budynków.\""),
            	NumSection(styleComment," [1993-1-6] Norma PN-EN 1993-1-6 \"Eurokod 3. Projektowanie konstrukcji stalowych. Część 1-6: Wytrzymałosć i stateczność konstrukcji powłokowych.\""),
            	NumSection(styleComment," [1993-4] Norma PN-EN 1993-4 \"Eurokod 3. Projektowanie konstrukcji stalowych. Część 4-1: Silosy.\"")
            ),
