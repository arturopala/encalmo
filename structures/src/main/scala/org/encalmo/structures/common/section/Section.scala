...
object SectionSymbols extends SymbolConfigurator {
    ...
    //Area
    val A = symbol(BasicSymbols.A) unit "m2"
    val AVz = symbol(BasicSymbols.A|"Vz") unit "m2"
    //Surface
    ...
    val Wz = symbol(BasicSymbols.W|("z")) unit "m3"
    val Wy = symbol(BasicSymbols.W|("y")) unit "m3"
    val Wzd = symbol(BasicSymbols.W|("z","d")) unit "m3"
    val Wyd = symbol(BasicSymbols.W|("y","d")) unit "m3"
    val Wzg = symbol(BasicSymbols.W|("z","g")) unit "m3"
    val Wyg = symbol(BasicSymbols.W|("y","g")) unit "m3"
    val Wzpl = symbol(BasicSymbols.W|"z,pl") unit "m3"
    val Wypl = symbol(BasicSymbols.W|"y,pl") unit "m3"
