...
class TRBWorksheet extends Worksheet("trb") {
    ...
    val We = W|e is "Wydajność godzinowa pracy pojedyńczej koparki"; We := (60*nk*Qk*Sn*Ss*Sw).setunit(SI.m3/SI.h)
    ...
    val Qw = Q|w is "Obliczona intensywność godzinowa zagęszczania mieszanki betonowej" unit SI.m3/SI.h; Qw := (Lwibr*BS*db*((3600 unit SI.s)/(tz1+tz2))*Sww).setunit(SI.m3/SI.h)
