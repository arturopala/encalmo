...
class MathMLPrinterTest extends AssertionsForJUnit {
	...
	@Test def testContext1() {
		...
		val a3 = Symbol3("Ar",BasicSymbols.a,BasicSymbols.b)
		val a4 = Symbol4("Ar",BasicSymbols.a,BasicSymbols.b,BasicSymbols.c)
		val a5 = Symbol5("Ar",BasicSymbols.a,BasicSymbols.b,BasicSymbols.c,BasicSymbols.d)
		val d = alpha!z
		val b = a5|d
		val e = (a1+a2+a3+a4+a5)*(b-1.3)+(sqrt(c^(2-r))/(sin(4.126)+x))+root(l*k,f-1)/cbrt(.123^f)
		o.open
